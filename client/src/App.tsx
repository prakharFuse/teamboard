            ...
            <form className="add-form" onSubmit={addMember}>
              ...
              <div className="form-row">
                ...
                <select value={department} onChange={e => setDepartment(e.target.value)} required>
                  ...
                  {Object.entries(DEPT_CODES).map(([code, name]) => (
            ...
            <tbody>
              {members.map(m => (
                <tr key={m.id}>
                  ...
                  <td>{m.email}</td>
                  <td>{m.role}</td>
                  <td><span className="dept-badge">{DEPT_CODES[m.department] ?? m.department}</span></td>
                  <td>{m.start_date}</td>
                  <td>
            ...
            <>
              ...
              <ul className="dept-list">
                {stats.byDepartment.map(d => (
                  <li key={d.department}>
                    <span>{DEPT_CODES[d.department] ?? d.department}</span>
