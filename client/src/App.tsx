...
import { DEPARTMENTS, DEPARTMENT_CODES } from './departments';
              ...
              <div className="form-row">
                ...
                <select value={department} onChange={e => setDepartment(e.target.value)} required>
                  ...
                  {DEPARTMENT_CODES.map(code => (
                    <option key={code} value={code}>{DEPARTMENTS[code]}</option>
                  ))}
                </select>
            ...
            <tbody>
              {members.map(m => (
                <tr key={m.id}>
                  ...
                  <td>{m.email}</td>
                  <td>{m.role}</td>
                  <td><span className="dept-badge">{DEPARTMENTS[m.department as keyof typeof DEPARTMENTS] ?? m.department}</span></td>
                  <td>{m.start_date}</td>
                  <td>
            ...
            <>
              ...
              <ul className="dept-list">
                {stats.byDepartment.map(d => (
                  <li key={d.department}>
                    <span>{DEPARTMENTS[d.department as keyof typeof DEPARTMENTS] ?? d.department}</span>
