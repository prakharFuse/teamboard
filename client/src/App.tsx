          ...
          {showForm && (
            <form className="add-form" onSubmit={addMember}>
              ...
              <div className="form-row">
                ...
                <select value={department} onChange={e => setDepartment(e.target.value)} required><option value="" disabled>Select department…</option>{departments.map(d => (<option key={d} value={d}>{d}</option>))}</select>
