...
import { DEPARTMENTS, deptName } from './departments';
            ...
            <tbody>
              {members.map(m => (
                <tr key={m.id}>
                  ...
                  <td>{m.email}</td>
                  <td>{m.role}</td>
                  <td><span className="dept-badge">{deptName(m.department) ?? m.department}</span></td>
                  <td>{m.start_date}</td>
                  <td>
            ...
            <>
              ...
              <ul className="dept-list">
                {stats.byDepartment.map(d => (
                  <li key={d.department}>
                    <span>{deptName(d.department) ?? d.department}</span>
